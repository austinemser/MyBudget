...
//  MyBudget
//
//  Created by Austin Emser on 7/18/16.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "ae.com.MyBudget" in the application's documents Application Support directory.
